...
output "verifier_v2_ecr_url" {
  description = "ECR repository URL for the Lambda verifier_v2 container image (KMS ECDSA)"
  value       = aws_ecr_repository.verifier_v2.repository_url
}
