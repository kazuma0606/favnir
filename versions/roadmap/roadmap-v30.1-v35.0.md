...
| 種別 | 意味 |
|---|---|
| **x.0.0** — マイルストーン宣言版 | 直前の x-1.1〜x-1.9 の成果を宣言 + **ビルドクリーンアップ実施** |
| **x.1〜x.9** — 実装版 | 機能・品質改善を 1 バージョン 1 テーマで順次実装 |

---

## クリーンアップ手順（各 x.0.0 マイルストーン完了時に必ず実施）

マイルストーン版（v31.0 / v32.0 / v33.0 / v34.0 / v35.0）をリリースするたびに、
以下のクリーンアップを実施して CI と同じクリーンな状態を確認する。
