...
pub const BUILTIN_FNS: &[BuiltinFn] = &[
    ...
    BuiltinFn {
        namespace: "IO",
        name: "write_file",
        signature: "(path: String, content: String) -> Result<Unit, String>",
    ...
    BuiltinFn {
        namespace: "Csv",
        name: "read",
        signature: "(path: String) -> Result<List<'a>, String>",
        params: &["path: String"],
    },
    BuiltinFn {
        namespace: "Csv",
        name: "write_file",
        signature: "(path: String, rows: List<'a>) -> Result<Unit, String>",
    ...
    BuiltinFn {
        namespace: "Http",
        name: "get",
        signature: "(url: String) -> Result<String, String>",
        params: &["url: String"],
    },
    BuiltinFn {
        namespace: "Http",
        name: "get_json",
        signature: "(url: String) -> Result<'a, String>",
        params: &["url: String"],
    },
    BuiltinFn {
        namespace: "Http",
        name: "post",
        signature: "(url: String, body: String) -> Result<String, String>",
        params: &["url: String", "body: String"],
    },
    BuiltinFn {
        namespace: "Http",
        name: "post_json",
        signature: "(url: String, body: 'a) -> Result<'b, String>",
    ...
    BuiltinFn {
        namespace: "Llm",
        name: "complete",
        signature: "(prompt: String) -> Result<String, String>",
        params: &["prompt: String"],
    },
    BuiltinFn {
        namespace: "Llm",
        name: "chat",
        signature: "(messages: List<{role: String, content: String}>) -> Result<String, String>",
        params: &["messages: List<{role: String, content: String}>"],
    },
    BuiltinFn {
        namespace: "Llm",
        name: "extract",
        signature: "(prompt: String, data: String) -> Result<'a, String>",
    ...
    BuiltinFn {
        namespace: "DB",
        name: "query",
        signature: "(sql: String) -> Result<List<'a>, String>",
        params: &["sql: String"],
    },
    BuiltinFn {
        namespace: "DB",
        name: "exec",
        signature: "(sql: String) -> Result<Unit, String>",
        params: &["sql: String"],
    },
    BuiltinFn {
        namespace: "DB",
        name: "query_one",
        signature: "(sql: String) -> Result<'a, String>",
        params: &["sql: String"],
    },
    // ── Env ───────────────────────────────────────────────────────────────────
    BuiltinFn {
